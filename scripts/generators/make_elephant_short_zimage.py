...
WORK = PROJECT_ROOT / "output" / "_work_elephant_zimage"
OUT = PROJECT_ROOT / "output" / "elephant_keeper_zimage_short.mp4"
IMGGEN_PY = PROJECT_ROOT / "imggen-env" / "Scripts" / "python.exe"
ZIMAGE_GEN = PROJECT_ROOT / "scripts" / "dev" / "zimage_gen.py"
