...
SCRIPT = (
    """Every autumn, forests explode into vibrant shades of red, orange, and yellow. During spring and summer, leaves are packed with a green pigment called chlorophyll, which helps trees turn sunlight into food. But as days get shorter and temperatures drop in autumn, trees prepare for winter hibernation. They stop producing chlorophyll, and the green color fades away. As the green disappears, other pigments that were hidden underneath finally get to show off! Carotenoids reveal bright yellows and oranges, while anthocyanins produce deep reds and purples. So, those beautiful autumn colors were actually hiding inside the leaves all summer long. It's just nature's way of getting ready for the cold."""
)
# Visual beats, in narrative order → free Openverse/Bing stills (no API key).
KEYWORDS = [
    "green forest summer",
    "sunlight shining on leaves",
    "autumn forest aerial",
    "red and orange leaves macro",
    "falling autumn leaves",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_leaves"
FINAL = OUT_DIR / "why_leaves_change_color.mp4"
