"""Make a ~50s animated explainer: 'Your Free Trial Is Quietly Charging You'

Topic #008 — personal finance · mid-high CPM
"""
...
# ── brain: ~132 words → ~54s at SAPI's ~148 wpm ──────────────────────────────
TITLE = "Your free trial is silently charging your card right now."
SCRIPT = (
    "You signed up for a free trial months ago. You never use it. But it is still "
    "charging you every single month. This is called a dark pattern subscription "
    "trap, and companies design it deliberately. Free trials require a credit card "
    "upfront, auto-convert to paid on day 15, send the cancellation email to your "
    "spam folder, and bury the cancel button six menu layers deep. A 2022 study "
    "found the average person wastes $133 per month on forgotten subscriptions. "
    "That is over $1,500 a year disappearing silently. Here is how to stop it: "
    "Use a virtual card number for every free trial. Services like Privacy.com "
    "let you create disposable card numbers that you can freeze the instant the "
    "trial ends. The charge gets declined. You pay nothing. And they cannot nag "
    "you because you never gave them a real card number."
)

KEYWORDS = [
    "credit card subscription payment",
    "phone notification app subscription",
    "free trial marketing sign up",
    "virtual card online security",
    "money wallet digital finance",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_freetrial"
FINAL = OUT_DIR / "free_trial_charging_you.mp4"
