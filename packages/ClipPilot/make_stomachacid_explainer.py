"""Make a ~50s animated explainer: 'Your Stomach Acid Is Strong Enough to Dissolve Metal'

Topic #027 — science/body · mid CPM
"""
...
TITLE = "Your stomach acid is strong enough to dissolve metal."
SCRIPT = (
    "The acid inside your stomach right now is genuinely terrifying. Gastric acid "
    "has a pH of between 1.5 and 3.5 — about the same strength as battery acid. "
    "That is strong enough to dissolve a razor blade given enough time. It can "
    "corrode galvanised steel. So the obvious question is: why isn't it dissolving "
    "your stomach right now? The answer is a thin layer of mucus, just a millimetre "
    "or two thick, lining the entire stomach wall. That mucus layer is constantly "
    "regenerated — your stomach replaces it every two weeks. The moment that "
    "process breaks down, the acid starts digesting the wall itself, which is "
    "exactly what a stomach ulcer is. The mucus is the only thing standing between "
    "your digestion system working perfectly and it literally eating itself alive."
)

KEYWORDS = [
    "stomach anatomy digestive system",
    "hydrochloric acid chemical laboratory",
    "human gut biology",
    "mucus layer protection microscope",
    "digestive organs human body",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_stomachacid"
FINAL = OUT_DIR / "stomach_acid_dissolve_metal.mp4"
