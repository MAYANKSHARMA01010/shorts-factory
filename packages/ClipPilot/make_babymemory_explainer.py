"""Make a ~50s animated explainer: "Nobody tells you why you can't remember being a baby"

Topic #022 — psychology/neuro · mid CPM
"""
...
SCRIPT = (
    "You were alive for years before your first memory. But why can't you "
    "remember any of it? For a long time, scientists thought babies simply "
    "couldn't form memories. Turns out, that is wrong. A groundbreaking 2025 study "
    "from Yale, led by neuroscientist Nicholas Turk-Browne, used fMRI scanners on "
    "one-year-old infants and found that their hippocampus — the brain's memory "
    "centre — absolutely lights up when they see a familiar face. Babies are "
    "encoding memories. The real problem is retrieval. As the brain grows rapidly "
    "in early childhood, new neurons flood the hippocampus and overwrite the old "
    "indexing system, making those early memories unretrievable. It is not that "
    "your early life didn't matter. It is just that your brain rebuilt itself "
    "and lost the filing system for those memories completely."
)

KEYWORDS = [
    "baby newborn sleeping peaceful",
    "hippocampus brain scan fMRI",
    "neurons forming connections",
    "childhood memory abstract",
    "brain development infant",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_babymemory"
FINAL = OUT_DIR / "why_cant_remember_baby.mp4"
