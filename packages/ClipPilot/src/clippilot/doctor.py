...
def check_readiness() -> dict[str, Any]:
    ...
    checks = [
        ...
        _check("Claude/Gemini AI brain", has_key or bool(os.environ.get("GEMINI_API_KEY")), "set" if (has_key or bool(os.environ.get("GEMINI_API_KEY"))) else "add ANTHROPIC_API_KEY or GEMINI_API_KEY to .env",
               "AI vision understanding, smart highlight picks, script/metadata (deterministic fallback otherwise)"),
    ...
    ready = {
        ...
        "brain": has_key or bool(os.environ.get("GEMINI_API_KEY")),
...
def format_report(report: dict[str, Any]) -> str:
    ...
    lines += ["", "Capabilities:",
              ...
              f"  Claude/Gemini brain : {'yes' if r['brain'] else 'no (deterministic fallback)'}",
