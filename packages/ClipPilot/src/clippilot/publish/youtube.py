...
class YouTubePublisher:
    ...
    def _build_body(self, title: str, description: str, tags: Optional[list[str]],
                    privacy: str, category_id: str = "22", language: str = "en",
        ...
        status = {
            "privacyStatus": "private" if publish_at else _PRIVACY.get(privacy, "private"),
        ...
        return {
            "snippet": {
                ...
                "defaultAudioLanguage": language or "en",
            },
            "status": status,
        }
    ...
    def upload_video(self, video_path: str, title: str, description: str = "",
                     ...
                     category_id: str = "22", language: str = "en",
                     publish_at: Optional[str] = None, dry_run: bool = False) -> dict[str, Any]:
        ...
        body = self._build_body(title, description, tags, privacy, category_id, language, publish_at)
        if dry_run:
