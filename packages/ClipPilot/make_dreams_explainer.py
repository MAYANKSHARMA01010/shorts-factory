...
SCRIPT = (
    """Every night, we enter bizarre, surreal worlds created entirely by our own minds. But why do we actually dream? Scientists believe it happens during REM, or Rapid Eye Movement sleep. During this stage, your brain is almost as active as when you are fully awake. One major theory is that dreaming helps us process our emotions and consolidate our memories. It's like your brain is running a simulation to sort through the events of the day, deciding what to keep and what to throw away. Another theory suggests dreams act as a virtual reality simulator to help us practice facing threats and dangers. While the exact purpose remains a mystery, one thing is certain: our brains are hard at work even when we are fast asleep."""
)
# Visual beats, in narrative order → free Openverse/Bing stills (no API key).
KEYWORDS = [
    "person sleeping peacefully",
    "brain neurons firing glowing",
    "surreal dream landscape",
    "memories floating abstract",
    "waking up morning sunlight",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_dreams"
FINAL = OUT_DIR / "why_we_dream.mp4"
