"""Make a ~50s animated explainer: 'The Parasite That May Be Controlling Your Brain'

Topic #023 — science/body · mid-high CPM
"""
...
TITLE = "A parasite may be influencing your behaviour."
SCRIPT = (
    "There is a single-celled parasite called Toxoplasma gondii that infects an "
    "estimated one in three people on Earth right now. Most people never even know "
    "they have it. It typically lies dormant, hidden in brain and muscle tissue. "
    "But in mice, the science is clear and eerie: infected mice actually lose their "
    "fear of cats, becoming easy prey — exactly what the parasite needs to reproduce "
    "inside a cat's gut. In humans, studies by researcher Jaroslav Flegr have found "
    "correlations between Toxoplasma infection and increased risk-taking behaviour, "
    "slower reaction times, and even altered personality traits. The research is "
    "still ongoing and correlation is not causation. But the possibility that a "
    "tiny organism might be nudging human decisions is genuinely unsettling science."
)

KEYWORDS = [
    "parasite microscope biology",
    "brain neuron network glowing",
    "cat staring mouse",
    "human silhouette mind control",
    "toxoplasma microscopy slide",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_parasite"
FINAL = OUT_DIR / "parasite_controlling_brain.mp4"
