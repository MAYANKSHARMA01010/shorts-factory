"""Make a ~50s animated explainer: 'Your Credit Card Is Lying to You'

Topic #001 — credit · $18–45 CPM
"""
...
TITLE = "Your credit card is lying to you about your score."
SCRIPT = (
    "You pay your credit card in full every month. You think your credit score is "
    "safe. But here is the problem: the date you pay and the date your bank "
    "reports to the credit bureaus are two completely different dates. Your bank "
    "reports your balance once per month, usually on your statement closing date. "
    "That happens before your payment due date. So even if you pay in full on "
    "time, the bureaus see a high balance every single month. That balance becomes "
    "your credit utilisation ratio — and it tanks your score, even though you "
    "never paid a penny in interest. The fix is simple: pay your balance down "
    "before your statement closing date, not the due date. One small calendar "
    "change, and your reported utilisation drops to near zero. Your score goes "
    "up. And you didn't change your spending at all."
)

KEYWORDS = [
    "credit card close-up",
    "credit score report document",
    "calendar payment due date",
    "bank statement balance",
    "financial stress money",
]

OUT_DIR = Path(__file__).resolve().parent / "data" / "explainer_creditcard"
FINAL = OUT_DIR / "credit_card_lying.mp4"
